...
<cfelse>
	<cfoutput>
	<p class="MainText" style="width: 600">Groups without a checkbox have already been added as a target, although their status may be active or disabled. The status listed below refers to the status of the group itself, not their status as a target.</p>
	...
	<cfoutput Query="qry_selectGroupList" Group="groupCategory">
		...
		<td align="center"><cfif ListFind(Form.groupID, qry_selectGroupList.groupID)>-<cfelse><input type="checkbox" name="groupID" value="#qry_selectGroupList.groupID#"></cfif></td>
		<td>&nbsp;</td>
