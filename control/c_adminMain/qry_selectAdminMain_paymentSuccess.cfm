...
<cfquery Name="qry_selectAdminMain_paymentSuccess" Datasource="#Application.billingDsn#" Username="#Application.billingDsnUsername#" Password="#Application.billingDsnPassword#">
	...
	WHERE avPayment.companyID = avCompany.companyID
		...
		AND avPayment.paymentApproved = <cfqueryparam Value="1" cfsqltype="cf_sql_tinyint">
