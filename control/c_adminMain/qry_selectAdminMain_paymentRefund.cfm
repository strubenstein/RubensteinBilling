...
<cfquery Name="qry_selectAdminMain_paymentRefund" Datasource="#Application.billingDsn#" Username="#Application.billingDsnUsername#" Password="#Application.billingDsnPassword#">
	...
	WHERE avPayment.companyID = avCompany.companyID
		...
		AND avPayment.paymentID_refund = <cfqueryparam Value="1" cfsqltype="cf_sql_tinyint">
