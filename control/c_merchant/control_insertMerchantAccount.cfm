...
<cfif IsDefined("Form.isFormSubmitted") and IsDefined("Form.submitInsertUpdateMerchantAccount")>
	...
	<cfelse>
		<cfinvoke Component="#Application.billingMapping#data.MerchantAccount" Method="insertMerchantAccount" ReturnVariable="newMerchantAccountID">
		...
		<cflocation url="index.cfm?method=merchant.listMerchantAccounts&confirm_merchant=#Variables.doAction#" AddToken="No">
	</cfif>
</cfif>

<cfset Variables.formAction = "index.cfm?method=merchant.#Variables.doAction#">
<cfset Variables.formSubmitValue = Variables.lang_insertUpdateMerchantAccount.formSubmitValue_insert>
